...
$hidden_patterns = ['*.php','.*','*.js',"replit.nix","script"]; // Matching files hidden in directory index
...
th {font-weight: normal; color: #1F75CC; background-color: powderblue; padding:.5em 1em .5em .2em;
